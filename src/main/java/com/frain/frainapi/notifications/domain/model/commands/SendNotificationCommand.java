...
public record SendNotificationCommand(NotificationMessage message, ResourceId resourceId, EmailAddress recipient, EmailAddress sender, NotificationType type) {
}
