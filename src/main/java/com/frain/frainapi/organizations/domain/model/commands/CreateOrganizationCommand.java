...
public record CreateOrganizationCommand(OrganizationName name, OrganizationVisibility visibility, UserId ownerUserId, MemberName ownerName, String ownerPictureUrl) {
}
